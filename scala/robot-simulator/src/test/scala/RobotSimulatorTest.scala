...
class RobotSimulatorTest extends FunSuite with Matchers {
  ...
  test(
    ...
    Robot(Bearing.North, (0, 0)).simulate("R").coordinates should be((0, 0))
  }
  ...
  test(
    ...
    Robot(Bearing.North, (0, 0)).simulate("R").bearing should be(Bearing.East)
  }
  ...
  test(
    ...
    Robot(Bearing.North, (0, 0)).simulate("L").coordinates should be((0, 0))
  }
  ...
  test(
    ...
    Robot(Bearing.North, (0, 0)).simulate("L").bearing should be(Bearing.West)
  }
